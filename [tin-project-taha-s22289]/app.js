...
const CustomerApiRoute = require('./routes/api/CustomerApiRoute');
const RentApiRoute = require('./routes/api/RentApiRoute');
...
app.use('/api/car', CarApiRoute);
app.use('/api/rent', RentApiRoute);
